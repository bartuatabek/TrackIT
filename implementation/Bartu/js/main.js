...
function init(workflowName) {
    ...
    if (workflowName != '') {
        ...
        basic_workflow += '<li><i class="fas fa-align-left"></i>Card Name</li><li><i class="fas fa-align-left"></i>Card Name</li><li><i class="fas fa-align-left"></i>Card Name</li><li><i class="fas fa-align-left"></i>Card Name</li><li><i class="fas fa-align-left"></i>Card Name</li><li class="cancel_drag"><div class="add-a-card">Add a card</div></li>';
