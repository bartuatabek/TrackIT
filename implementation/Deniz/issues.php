...
<body>
    ...
    <div class="container issue-container" id="issue-container">
        <div class="card-columns" id="card-columns">
            <?php
                include ("config.php");
                $sql = "SELECT name , status , start_date, end_date, priority , note FROM Issue WHERE project_id='1'";
            ...
            <div class="card issue-card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col">
                            <p class="text-right"> <?php echo $row['status'] ?> </p>
                        </div>
                    </div>
                ...
                <div class="card-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 align-self-right">
                            <button type="button resolve-btn" class="btn btn-success">Resolve</button>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="submitButton" onclick="createIssueCard(this)" data-dismiss="modal" class="btn btn-success">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
